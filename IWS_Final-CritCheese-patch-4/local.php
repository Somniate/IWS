...
$sql = "SELECT * FROM articles INNER JOIN categories ON articles.category_article = categories.id_category AND categories.id_category = 1";
            ...
            <div>
                ...
                <?php else : ?>
                    ...
                    <div class ="w3-row-padding w3-third">
                        <div class="w3-container w3-panel w3-border w3-border-w3-camo-verydarkgrey w3-round-xxlarge">
