...
$sql = "SELECT * FROM articles INNER JOIN categories ON articles.category_article = categories.id_category AND categories.id_category = 1 LIMIT $this_page_first_result, $limit";
...
<body>
    ...
    for ($page=1;$page<=$number_of_pages;$page++) {
        echo '<a href="local.php?page=' . $page . '">' . $page . '</a> ';
      }
